                          ...
                          ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () => allergyProvider
                                  .removeTreeNutsAndCorrespondingNuts(), // Remove "Tree Nuts" and corresponding nuts
                            ),
                          ),
                          ...
                          ListTile(
                            ...
                            trailing: IconButton(
                              icon: const Icon(
                                  Icons.delete), // Delete icon button
                              onPressed: () => allergyProvider
                                  .removeCrustaceanShellfishAndCorrespondingShellfish(), // Remove "Crustacean Shellfish" and corresponding shellfish
                            ),
                          ),
                          ...allergyProvider.crustaceanShellfish
                            ...
                            return allergyProvider.allergies.contains(shellfish)
                                ? Padding(
                                    ...
                                    child: ListTile(
                                      title: Text(capitalizeFirstLetter(
                                          shellfish)), // Display capitalized shellfish
                                      trailing: IconButton(
                                        icon: const Icon(
                                            Icons.delete), // Delete icon button
                                        onPressed: () =>
                                            allergyProvider.removeShellfish(
                                                shellfish), // Remove specific shellfish
                                      ),
                                    ),
                                  )
                                : Container();
                          ...
                          ListTile(
                            ...
                            trailing: IconButton(
                              icon: const Icon(
                                  Icons.delete), // Delete icon button
                              onPressed: () => allergyProvider
                                  .removeFishAndCorrespondingFish(), // Remove "Fish" and corresponding fish
                            ),
                          ),
                                    ...
                                    child: ListTile(
                                      ...
                                      trailing: IconButton(
                                        icon: const Icon(
                                            Icons.delete), // Delete icon button
                                        onPressed: () =>
                                            allergyProvider.removeFish(
                                                fish), // Remove specific fish
                                      ),
                                    ),
                                  )
                                : Container();
                          ...
                          ListTile(
                            ...
                            trailing: IconButton(
                              icon: const Icon(
                                  Icons.delete), // Delete icon button
                              onPressed: () => allergyProvider
                                  .removeLegumesAndCorrespondingLegumes(), // Remove "Legumes" and corresponding legumes
                            ),
                          ),
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: TextField(
                            controller:
                                _controller, // Controller for text input
                            decoration: const InputDecoration(
                              labelText:
                                  'Input Single Allergen', // Input field label
                            ),
                          ),
                        ),
                        IconButton(
                      ...
                      children: [
                        Expanded(
                          child: DropdownButton<String>(
                            hint: const Text(
                                'Select Group Allergen'), // Dropdown hint text
                            value:
                          ...
                          onPressed: () {
                            if (_selectedGroupAllergen != null) {
                              ...
                              if (_selectedGroupAllergen == 'Tree Nuts') {
                                totalAllergies += allergyProvider
                                    .treeNuts.length; // Add tree nuts count
                              } else if (_selectedGroupAllergen ==
                                  'Crustacean Shellfish') {
                                totalAllergies += allergyProvider
                                    .crustaceanShellfish
                                    .length; // Add crustacean shellfish count
                              } else if (_selectedGroupAllergen == 'Fish') {
                                totalAllergies += allergyProvider
                                    .fish.length; // Add fish count
                              } else if (_selectedGroupAllergen == 'Legumes') {
                                totalAllergies += allergyProvider
                                    .legumes.length; // Add legumes count
                              }
